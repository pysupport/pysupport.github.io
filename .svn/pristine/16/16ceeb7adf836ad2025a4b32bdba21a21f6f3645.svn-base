...
function scroll() {
    var top = $('.navbar-header')[0]
    var nav = $('.navbar-collapse .navbar-nav')[0]
    var logo = $('.logo-header')[0]
    var navA = $('.nav-a')
